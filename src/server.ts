...
const executeInputSchema = z.object({
	code: z.string().describe('One ES module. Default-export async function main(params).'),
	params: z.record(z.string(), z.unknown()).optional().describe('Passed as the first argument to main'),
})

const server = new McpServer({ name: 'local-kody', version: '0.1.0' }, { instructions })
